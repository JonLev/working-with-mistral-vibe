---
name: learn-quiz
description: Quiz the user on recently written or accepted code with questions at five levels, from recall to synthesis, asked one at a time with feedback on each answer. Use when the user asks to be quizzed on code they just wrote or accepted; not for writing tests or reviewing a diff.
---
...
Text after `/learn-quiz` arrives as extra instructions: treat it as the focus
topic or flags.

## Instructions

1. Identify the last code I worked with (wrote, edited, or accepted from the agent)
...
Vibe: Looking at your last code - the useEffect hook for data fetching.
