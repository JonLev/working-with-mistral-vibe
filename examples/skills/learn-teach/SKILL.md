---
name: learn-teach
description: Teach a concept step by step with progressive depth - one-sentence definition, why it matters, a minimal example broken down line by line, a practical example, common mistakes, and next concepts. Use when the user asks to be taught or walked through a concept; not for quiz-style testing or implementation work.
---
...
Text after `/learn-teach` arrives as extra instructions: treat it as the
concept to teach, with any depth flags.
